...
<schema fpi="http://schemas.opengis.net/om/2.0/sweObservation.sch"
    ...
    <p>Verifies that all instances of OM_Observation or elements derived from OM_Observation (i.e. having an om:resultTime property) have a result that matches the pattern for SWEObservations</p>
    <ns
        prefix="om"
