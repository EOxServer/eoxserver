OpenGIS(r) OLS 1.2.0 - ReadMe.txt 
=================================
...
* Latest version is: http://schemas.opengis.net/ols/1.2/olsAll.xsd *
...
2010-11-17  Simon Cox
  ...
  * v1.2: Changes to 1.2.0 create OLS 1.2.1
    ...
    + created ols/1.1 version from OLS 1.2.1
